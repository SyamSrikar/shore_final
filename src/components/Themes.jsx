...
function Themes(props) {
  return (
    <>
        <Flex flexDir={'column'} justifyContent={'center'} marginTop={'30px'} alignItems={'center'} paddingX={props.value?'10px':'50px'} backgroundColor={'#020710'} color={'white'} flexWrap={'wrap'}>
